...
CSS;
  ...
  private function cardLabels(string $mode): array {
    $en = [
      ...
      'points' => 'points', 'unlocked' => 'is unlocked', 'more_points' => 'more points to unlock',
    ...
    $ar = [
      ...
      'points' => 'نقطة', 'unlocked' => 'متاحة الآن', 'more_points' => 'نقطة إضافية للحصول على',
